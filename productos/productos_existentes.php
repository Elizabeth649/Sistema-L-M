...
<div class="w-4/5 p-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">PRODUCTOS EXISTENTES</h1>
        </div>
    ...
    <table class="min-w-full bg-white">
        ...
        <tr class="bg-pink-200 text-left">
            ...
            <th class="py-2 px-4 border text-center">Cantidad Existente</th>
            <th class="py-2 px-4 border text-center">Categoría</th>
            <th class="py-2 px-4 border text-center">Precio del producto por unidad (LyM)</th>
        ...
        <tbody id="productTableBody">
            ...
            // Consulta para calcular la cantidad restante de productos (cantidad - cantidad vendida)
            $sql = "SELECT p.id, p.nombre, p.descripcion, 
               (p.cantidad - IFNULL(SUM(v.cantidad), 0)) AS cantidad_disponible, 
            ...
            if ($result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row["cantidad_disponible"]) . "</td>";
                    ...
                    echo "<td class='py-2 px-4 border text-center'>" . htmlspecialchars($row["fecha_vencimiento"]) . "</td>"; // Mostrar fecha de vencimiento
                    echo "</tr>";
                }
            } else {
                echo "<tr><td colspan='7' class='py-2 px-4'>No hay productos existentes</td></tr>";
            }
